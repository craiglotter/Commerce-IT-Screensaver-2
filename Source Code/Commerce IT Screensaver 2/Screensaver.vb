...
#End Region
        ...
        Try
            ...
            Try
                If My.Computer.FileSystem.FileExists((Application.StartupPath & "\AutoUpdate.exe").Replace("\\", "\")) = True Then
                    ...
                    startinfo.Arguments = "updateonly"
                    startinfo.CreateNoWindow = False
                    Process.Start(startinfo)
                End If
            Catch ex As Exception
                Error_Handler("AutoUpdate: " & ex.Message)
            End Try
            Application.Exit()
        Catch ex As Exception
    ...
    Private Sub Loader()
        Try
            Cursor.Hide()
            AxShockwaveFlash1.Movie = (Application.StartupPath & "\Commerce IT Screensaver 2.swf").Replace("\\", "\")
